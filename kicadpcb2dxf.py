...
with r12writer(out_filename) as dxf:
    ...
    for line in content:
        ...
        if "fp_line" in line:
            ...
            if "Cmts" in line:
                layer="Cmts"; color=1; create=0
            if "Dwgs" in line:
                layer="Dwgs"; color=2; create=0
            if "Eco1" in line:
                layer="Eco1"; color=3; create=0
            if "Eco2" in line:
                layer="Eco2"; color=4; create=0
            if "F.Fab" in line:
                layer="FFab"; color=5; create=0
            if "B.Fab" in line:
                layer="BFab"; color=6; create=0
            if "F.CrtYd" in line:
                layer="FCrtYd"; color=7; create=0
            if "B.CrtYd" in line:
                layer="BCrtYd"; color=8; create=0
            if create==1:
        ...
        if "gr_text" in line:
            ...
            if "Cmts" in line:
                layer="Cmts"; color=1; createTxt=0
            if "Dwgs" in line:
                layer="Dwgs"; color=2; createTxt=0
            if "Eco1" in line:
                layer="Eco1"; color=3; createTxt=0
            if "Eco2" in line:
                layer="Eco2"; color=4; createTxt=0
            if "F.Fab" in line:
                layer="FFab"; color=5; createTxt=0
            if "B.Fab" in line:
                layer="BFab"; color=6; createTxt=0
            if "F.CrtYd" in line:
                layer="FCrtYd"; color=7; createTxt=0
            if "B.CrtYd" in line:
                layer="BCrtYd"; color=8; createTxt=0
            if createTxt==1:        
        ...
        if "(dimension" in line:
            align="MIDDLE_CENTER"
            if "Edge" in line:
                layer=0; color=None; dimension=1
            if "Cmts" in line:
                layer="Cmts"; color=1; dimension=0
            if "Dwgs" in line:
                layer="Dwgs"; color=2; dimension=0
            if "Eco1" in line:
                layer="Eco1"; color=3; dimension=0
            if "Eco2" in line:
                layer="Eco2"; color=4; dimension=0
            if "F.Fab" in line:
                layer="FFab"; color=5; dimension=0
            if "B.Fab" in line:
                layer="BFab"; color=6; dimension=0
            if "F.CrtYd" in line:
                layer="FCrtYd"; color=7; dimension=0
            if "B.CrtYd" in line:
                layer="BCrtYd"; color=8; dimension=0
